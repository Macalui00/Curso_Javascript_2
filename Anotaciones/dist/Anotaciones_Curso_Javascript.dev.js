...
fakeRequest("/users").then(function (res) {
  // console.log(res.data(0).id);
  var id = res.data(0).id;
  fakeRequest("/users/".concat(id)).then(function (res) {
    var postId = res.data.topPostId; // console.log(res);

    fakeRequest("/posts/".concat(postId)).then(function (res) {
      console.log(res);
    });
  });
})["catch"](function (err) {
...
fakeRequest("/files").then(function (res) {
  // console.log(res.data(0).id);
  var id = res.data(0).id;
  fakeRequest("/users/".concat(id)).then(function (res) {
    var postId = res.data.topPostId; // console.log(res);
...
fakeRequest("/files").then(function (res) {
  ...
  console.logs(res);
  var id = res.data(0).id;
  return fakeRequest("/users/".concat(id));
}).then(function (res) {
  console.logs(res);
  var postId = res.data.topPostId;
  return fakeRequest("/posts/".concat(postId));
}).then(function (res) {
  console.log(res);
})["catch"](function (err) {
  console.log('Oh No!', err);
